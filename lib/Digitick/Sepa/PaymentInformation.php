...
class PaymentInformation
{
	...
	/**
     * @var string Debtor's adress one.
     */
    public $originAddressOne;
	
	/**
     * @var string Debtor's adress two.
     */
    public $originAddressTwo;
	
	/**
     * @var string Debtor's country.
     */
	 ...
	 * @param string $originAddressOne This is your Address (first line)
	 * @param string $originAddressTwo This is your Address (second line)
	 * @param string $originCountry This is your Country
     * @param string $originAccountCurrency
     */
    public function __construct($id, $originAccountIBAN, $originAgentBIC, $originName, $originAddressOne, $originAddressTwo, $originCountry, $originAccountCurrency = 'EUR')
    {
        $this->id = $id;
		...
		$this->originAddressOne = StringHelper::sanitizeString($originAddressOne);
		$this->originAddressTwo = StringHelper::sanitizeString($originAddressTwo);
		$this->originCountry = StringHelper::sanitizeString($originCountry);
	...
	/**
     * @param string $originAddressOne
     */
    public function setOriginAddressOne($originAddressOne)
    {
        $this->originAddressOne = StringHelper::sanitizeString($originAddressOne);
    }
     ...
     * @return string
     */
    public function getOriginAddressOne()
    {
        return $this->originAddressOne;
    }
	
	/**
     * @param string $originAddressTwo
     */
    public function setOriginAddressTwo($originAddressTwo)
    {
        $this->originAddressTwo = StringHelper::sanitizeString($originAddressTwo);
    }
     ...
     * @return string
     */
    public function getOriginAddressTwo()
    {
        return $this->originAddressTwo;
    }
